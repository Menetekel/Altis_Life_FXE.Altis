...
BTC_l_unload =
{
	...
	if (_id != -1) then
	{
		...
		_obj setpos (_veh modelToWorld [0,-15,0]);
		_obj setDamage 0;
		switch (true) do
		{
			case (_height >= 20):
			...
			case (_height < 2):
			{
				_obj setpos (_veh modelToWorld [0,-10,0]);
				_obj setDamage 0;
			};
		};
	};
