...
{
	//Lift
	BTC_lift_pilot    = ["B_engineer_F","B_medic_F","O_medic_F"];
	BTC_lift          = 0;
	BTC_lifted        = 0;
	BTC_lift_min_h    = 5;
	BTC_lift_max_h    = 20;
...
if (BTC_active_fast_rope == 1) then
{
	//Fast roping
	BTC_fast_rope_h = 35;
	BTC_fast_rope_h_min = 10;
	BTC_roping_chopper = ["B_Heli_Transport_01_F","B_Heli_Transport_01_camo_F","I_Heli_Transport_02_F","B_Heli_Light_01_F","O_Heli_Light_02_F","I_Heli_light_03_unarmed_F","O_Heli_Light_02_unarmed_F"];
