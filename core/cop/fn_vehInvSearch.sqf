...
if(_value > 0) then
{
	[[0,format["Das Fahrzeug wurde durchsucht. Die Drogen haben einene Wert von  €%1",[_value] call life_fnc_numberText]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	life_atmcash = life_atmcash + _value;
	_vehicle setVariable["Trunk",[],true];
}
	else
{
	hint "Keine Illegalen Dinge im Auto.";
};