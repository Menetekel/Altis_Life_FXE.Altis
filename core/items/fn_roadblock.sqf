...
life_action_roadblockDeploy = player addAction["Place Spike Strip",{if(!isNull life_roadblock) then {detach life_roadblock; life_roadblock = ObjNull;}; player removeAction life_action_roadblockDeploy; life_action_roadblockDeploy = nil;},"",999,false,false,"",'!isNull life_roadblock'];
