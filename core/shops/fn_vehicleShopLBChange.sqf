...
"Rental Price: <t color='#8cff9b'>$%1</t><br/>Kaufpreis: <t color='#8cff9b'>$%2</t><br/>max. Geschw.: %3 km/h<br/>PS: %4<br/>Passagiere: %5<br/>Kofferraum: %6<br/>Tankvolumen: %7<br/>Panzerung: %8",
