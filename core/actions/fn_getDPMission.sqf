...
life_cur_task setSimpleTaskDescription [format["Du musst dieses Packet an %1 ausliefern.",toUpper _dp],"Delivery Job",""];
life_cur_task setTaskState "Assigned";
player setCurrentTask life_cur_task;

["DeliveryAssigned",[format["Liefer diese Packt an %1",toUpper _dp]]] call bis_fnc_showNotification;
...
[] spawn
{
	...
	if(!alive player) then
	{
		...
		["DeliveryFailed",["Du hast die Lieferung nicht zugestellt weil du gestorben bist."]] call BIS_fnc_showNotification;
