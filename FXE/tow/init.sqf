...
[] spawn
{
	...
	call compile preprocessFile format ["FXE\tow\%1_strings_lang.sqf", R3F_ARTY_AND_LOG_CFG_langage];
	...
	if (isDedicated) then
	{
		...
		//execVM "FXE\tow\surveiller_nouveaux_objets_dedie.sqf";
	}
	else
	{
		execVM "FXE\tow\surveiller_nouveaux_objets.sqf";
